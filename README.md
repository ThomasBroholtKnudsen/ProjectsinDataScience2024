...
Line 44: Provide the column name containing the image IDs from the metadat-file.\
...
Line 26: The metadata file, created from our subset of the PAD-UFES-20 currently set to "data\okapi_data_metadata.csv".\
